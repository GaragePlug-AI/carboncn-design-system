// Static content sections for the LLM prompt (PROMPT.md)
// These are the design system principles, patterns, and guidelines

export const PROMPT_INTRO = `# CarbonCN Design System - Complete Guide for AI Assistants
...
For the latest components and updates, visit: {{GITHUB_URL}}
`
...
export const PROMPT_COMPONENT_ANATOMY = `
---
...
export const PROMPT_ACCESSIBILITY = `
---
...
export const PROMPT_DOS_AND_DONTS = `
---
...
// Combine all sections into the full prompt
export function generateStaticPromptSections(githubUrl: string): string {
  return [
    PROMPT_INTRO.replace("{{GITHUB_URL}}", githubUrl),
    PROMPT_PRINCIPLES,
    PROMPT_ARCHITECTURE,
    PROMPT_COMPONENT_ANATOMY,
    PROMPT_STYLING,
    PROMPT_PATTERNS,
